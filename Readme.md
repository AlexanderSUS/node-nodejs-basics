...
Clone this repo
```
git clone git@github.com:AlexanderSUS/node-nodejs-basics.git
```
...
npm run fs:delete
```
To show files in current folder run 
```
npm run fs:list
```
To read file run
...
To parse presetted environment variables run
```
npm run cli:env
```
To parce presetted cli args run
```
npm run cli:args
```
**Modules(src/modules)**

To run modules task execute command
```
npm run modules
```
**Hash (src/hash)**

To get hash from presetted file run
```
npm run hash
```
**Streams (src/streams)**

To read presetted file using Readable Stream run
```
npm run streams:read
```
To write in file using Readable Stream run
```
npm run streams:write
```
To transform data from presetted file by Transform Stream run
```
npm run streams:transform
```
**Zlib (src/zip)**

To compress presetted file run
```
npm run zlib:compress
```
To decompress presetted file run
```
...
npm run cp
```
To run script that creates workers according your cpus number run
```
npm run wt
```
